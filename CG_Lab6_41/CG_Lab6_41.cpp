...
public:
    ...
    bool Init()
    {
        ...
        if (!m_mesh.LoadMesh("C:/Users/ASUS/source/repos/CG_Lab6/Content/boblampclean.md5mesh")) {
        ...
        if (!m_quad.LoadMesh("C:/Users/ASUS/source/repos/CG_Lab6/Content/quad_r.obj")) {
    ...
    /* Каждый пиксель экрана будет обработан 1 раз и в этот момент и будет вычислен эффект размытия.*/
    void MotionBlurPass()
    {
...
int main(int argc, char** argv)
{
    ...
    if (!GLUTBackendCreateWindow(WINDOW_WIDTH, WINDOW_HEIGHT, false, "Chelyshkina Tutorial 41")) {
        return 1;
    }
