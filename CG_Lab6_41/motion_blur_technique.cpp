...
bool MotionBlurTechnique::Init()
{
    ...
    if (!AddShader(GL_VERTEX_SHADER, "C:/Users/ASUS/source/repos/CG_Lab6/shaders/shaders_41/motion_blur.vs")) {
        return false;
    }

    if (!AddShader(GL_FRAGMENT_SHADER, "C:/Users/ASUS/source/repos/CG_Lab6/shaders/shaders_41/motion_blur.fs")) {
        return false;
    }
