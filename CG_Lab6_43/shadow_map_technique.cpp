...
bool ShadowMapTechnique::Init()
{
    ...
    if (!AddShader(GL_VERTEX_SHADER, "C:/Users/ASUS/source/repos/CG_Lab6/shaders/shaders_43/shadow_map.vs")) {
        return false;
    }

    if (!AddShader(GL_FRAGMENT_SHADER, "C:/Users/ASUS/source/repos/CG_Lab6/shaders/shaders_43/shadow_map.fs")) {
        return false;
    }
