...
public:
    ...
    bool Init()
    {
        ...
        if (!m_quad.LoadMesh("C:/Users/ASUS/source/repos/CG_Lab6/Content/quad.obj")) {
            return false;
        }
        ...
        if (!m_mesh.LoadMesh("C:/Users/ASUS/source/repos/CG_Lab6/Content/phoenix_ugv.md2")) {
            return false;
        }
...
int main(int argc, char** argv)
{
    ...
    if (!GLUTBackendCreateWindow(WINDOW_WIDTH, WINDOW_HEIGHT, false, "Chelyshkina Tutorial 42")) {
        return 1;
    }
